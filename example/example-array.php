...
if(isset($_POST['content']))
{
    ...
    $dictionaryModerateWords = array(
        'consectetur',
        'neque',
        'velit'
    );

    $dictionaryReject = new \Badword\Dictionary\PhpArray($dictionaryRejectWords, 2);
    $dictionaryModerate = new \Badword\Dictionary\PhpArray($dictionaryModerateWords, 1);
